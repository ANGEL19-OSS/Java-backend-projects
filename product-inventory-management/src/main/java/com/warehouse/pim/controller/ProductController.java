...
import com.warehouse.pim.dto.ApiResponse;
...
@Tag(name = "Product Inventory API", description = "Endpoints for managing product records in the warehouse")
public class ProductController {

    private final ProductService productService;

    @PostMapping
    @Operation(summary = "Add a new product", description = "Creates a new product record in the warehouse inventory")
    ...
    @Operation(summary = "Search products by category", description = "Finds products belonging to a specified category with pagination and sorting")
